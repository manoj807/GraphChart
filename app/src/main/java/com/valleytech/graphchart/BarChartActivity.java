...
import com.valleytech.graphchart.custom.MyAxisValueFormatter;
import com.valleytech.graphchart.custom.XYMarkerView;
import com.valleytech.graphchart.notimportant.DemoBase;
import com.valleytech.graphchart.utils.Fill;
...
public class BarChartActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    private void setData(int count, float range) {
        ...
        if (chart.getData() != null &&
            ...
            List<BarEntry> gradientFills = new ArrayList<>();
            gradientFills.add(new BarEntry(startColor1, endColor1));
            gradientFills.add(new BarEntry(startColor2, endColor2));
            gradientFills.add(new BarEntry(startColor3, endColor3));
            gradientFills.add(new BarEntry(startColor4, endColor4));
            gradientFills.add(new BarEntry(startColor5, endColor5));
            set1.setValues(gradientFills);
